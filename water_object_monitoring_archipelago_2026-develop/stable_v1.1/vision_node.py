...
def run_standalone(duration=None, require_aruco=True, tilt_camera=True, use_roi=True, stride=3):
...
if __name__ == "__main__":
    ...
    ap.add_argument("--stride", type=int, default=3, help="тяжёлую обработку раз в N кадров (производительность)")
    a = ap.parse_args()
