...
def main():
    ...
    POINTS = {
        "0":  {"x": 0,    "y": 4.7,  "z": 1.5,  "yaw": 0, "speed": 5,  "hover": False, "label": "[Точка 0]"},
        "1":  {"x": -1.8, "y": 4.0,  "z": 2.5,  "yaw": 0, "speed": 5,  "hover": True,  "label": "[Точка 1]"},
        "2":  {"x": -2.2, "y": 4.0,  "z": 2.5,  "yaw": 0, "speed": 10, "hover": True,  "label": "[Точка 2]"},
        "3":  {"x": -2.2, "y": 1.3,  "z": 2.5,  "yaw": 0, "speed": 20, "hover": True,  "label": "[Точка 3]"},
        "4":  {"x": -1.8, "y": 1.3,  "z": 2.5,  "yaw": 0, "speed": 10, "hover": True,  "label": "[Точка 4]"},
        "5":  {"x": 0,    "y": 1.3,  "z": 1,    "yaw": 0, "speed": 5,  "hover": False, "label": "[Точка 5]"},
        "6a": {"x": 1,    "y": 0.5,  "z": 0.5,  "yaw": 0, "speed": 5, "hover": False, "label": "[Точка 6 - Снижение 1]"},
        "6b": {"x": 1,    "y": 0.5,  "z": 0.25, "yaw": 0, "speed": 5, "hover": False, "label": "[Точка 6 - Снижение 2]"},
        "6c": {"x": 1,    "y": 0.5,  "z": 0.1,  "yaw": 0, "speed": 5, "hover": False, "label": "[Точка 6 - Снижение 3]"},
    }
