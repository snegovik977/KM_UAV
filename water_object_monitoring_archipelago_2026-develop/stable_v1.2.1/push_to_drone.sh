#!/usr/bin/env bash
# ============================================================================
#  СТАБИЛЬНАЯ ВЕРСИЯ v1.2.1 -> дрон   (лучшая на текущий момент)
#  Новое в v1.2.1 (поверх v1.2):
#    - подробные ИТОГИ в терминал: список судов с id ("Зарегистрированные суда: id 7 …");
#    - лог событий прямо на трансляции (колонка EVENTS справа сверху, EN).
#  База v1.2 (отличия от v1.1):
...
#
#  Запускать с Mac из папки stable_v1.2.1/:
...
echo ">>> Заливка стабильной версии v1.2.1 на ${DRONE}:${DEST}"
