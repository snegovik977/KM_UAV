...
def змеиный_конфиг():
    """Боевой конфиг, переключённый на змейку. Умолчание с 01.08.2026 — прямоугольник
    от точки взлёта (tests/test_route_rect.py); режим здесь задаётся явно, чтобы тест
    не начал молча проверять другую фигуру при следующей смене расстановки."""
